...
public class TestTransactions
{
    ...
    /**
     * Tests transfer between accounts with invalid accounts that belong to different customers.
     */
    @Test
	@Order(5)
    ...
    {    
    	...
    	assertEquals("java.sql.SQLException: Transfer failed because accounts do not belong to same customer.", response);    	    	    	 
    }
    ...
    {    
    	...
    	// Start transaction to get totals and update an account balance at the same time  
